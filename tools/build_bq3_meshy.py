"""Commission the single approved revision03 inspection kiosk through Meshy without exposing the existing credential."""
import base64
import json
import sys
...
ART = ROOT / 'assets/blackridge_quarantine_revision03/meshy'
KEY_PATH = Path('C:/Users/conra/Desktop/blackledger/.secrets/meshy_api_key.txt')
NAMES = ('inspection_kiosk',)
