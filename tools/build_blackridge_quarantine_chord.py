"""Run the project's existing CHORD recipe against one authored quarantine material."""
...
SOURCE=ROOT/'assets/blackridge_quarantine'/sys.argv[1]
...
for key in ('10','11','12','13'):
    workflow[key]['inputs']['filename_prefix']='mts/quarantine_'+SOURCE.stem+'_'+key
response=requests.post(SERVER+'/prompt',json={'prompt':workflow,'client_id':'quarantine_chord'},timeout=60)
response.raise_for_status()
