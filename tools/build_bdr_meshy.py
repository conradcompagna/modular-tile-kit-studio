"""Commission the subordinate cavern binding reliquary through Meshy without exposing the existing credential."""
import base64
import json
import sys
