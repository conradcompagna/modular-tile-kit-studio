...
SOURCE=ROOT/'assets/blackridge_quarantine_revision'/sys.argv[1]
...
for key in ('10','11','12','13'):
    workflow[key]['inputs']['filename_prefix']='mts/bqr_'+SOURCE.stem+'_'+key
response=requests.post(SERVER+'/prompt',json={'prompt':workflow,'client_id':'bqr_chord'},timeout=60)
response.raise_for_status()
