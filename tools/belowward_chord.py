...
SOURCE=ROOT/'assets/belowward_cell'/sys.argv[1]
...
for key in ('10','11','12','13'):
    workflow[key]['inputs']['filename_prefix']='mts/belowward_'+SOURCE.stem+'_'+key
response=requests.post(SERVER+'/prompt',json={'prompt':workflow,'client_id':'belowward_chord'},timeout=60)
response.raise_for_status()
