"""Commission the shared warden monument through Meshy without exposing the existing credential."""
import base64
import json
import sys
...
ART = ROOT / 'assets/blackridge_intake_revision/meshy'
KEY_PATH = Path('C:/Users/conra/Desktop/blackledger/.secrets/meshy_api_key.txt')
NAMES = ('census_engine','evidence_archive')
