"""Commission three focal props through Meshy without exposing the existing credential."""
import base64
import json
import sys
...
ART = ROOT / 'assets/belowward_cell/meshy'
KEY_PATH = Path('C:/Users/conra/Desktop/blackledger/.secrets/meshy_api_key.txt')
NAMES = ('skeletal_rack', 'wardens_desk', 'interrogation_frame')
