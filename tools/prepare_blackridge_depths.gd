...
func run() -> Dictionary:
	...
	var raw: Dictionary = plugin.board._read_board_json("res://exports/blackridge_depths/board_candidate.json")
	...
	board.save_json("res://exports/blackridge_depths/board_prepared.json")
